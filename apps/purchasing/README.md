...
The backend proxies only these tables: `items`, `quotes`, `quote_components` (read), `suppliers`, `purchase_orders`, `po_components`, `financial_obligations` (read/write). StockIt still enforces role permissions and payload validation.
