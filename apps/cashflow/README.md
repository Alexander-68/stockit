...
- The forecast lists the designation names behind each row, so the printed report carries them too; the row details show the full `CODE - Name`.
- Currency choices are fixed: USD, TWD, CNY, EUR.
